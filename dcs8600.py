...
if __name__ == '__main__':
    ...
    #parser.add_argument("--macsuffix", help="First run name, last two bytes of mac DCS-8600LH-####")
    ...
    #lighthttpd and rtspd is not on the original 8600
    ...
    if args.telnetd:
        ...
        cam.run_command("ps|grep -q [t]elnetd||telnetd")
    if args.attrs:
       cam.dumpchars()
